...
public class DrawRouteAsync extends AsyncTask<Void, Void, RouteDetails> 
{
	private GoogleMap map;

	private ImageButton routeFragmentProgressPlaceholder;
	private RelativeLayout routeFragmentBottomBar;
	...
	public DrawRouteAsync(RelativeLayout bottomBar, int MapsPolylineWidth, ImageButton button, FragmentCommunicator comm, GoogleMap map, String json, int route)
	{		
		this.routeFragmentBottomBar = bottomBar;
		this.MapsPolylineWidth = MapsPolylineWidth;
		this.map = map;
		this.comm = comm;
		this.json = json;
